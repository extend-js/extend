...
export function reflectionSubtitle(this: PageEvent): string {
  if (this.model) {
    if (this.model.kind && this.model.kind !== ReflectionKind.Module) {
      ...
      if (this.model.parent && this.model.parent.parent) {
        if (this.model.parent.parent.parent) {
          title.push(`[${this.model.parent.parent.name}](${relativeURL(this.model.parent.parent.url)})`);
        }
        title.push(`[${this.model.parent.name}](${relativeURL(this.model.parent.url)})`);
      }
